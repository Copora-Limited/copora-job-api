...
function resetPasswordEmail(user, resetToken) {
    return `
                ...
                <div class="email-body" style="background-color: #ffffff; border-radius: 4px">
                    ...
                    <a href="${config_1.FRONTEND_URL}/auth/reset-password?token=${resetToken}" style="display: inline-block; margin: 20px 0; padding: 10px 20px; font-size: 16px; color: #fff; background-color: #211c1c; text-decoration: none; border-radius: 5px;">Reset Password</a>
                    <p style="font-size: 16px; color: #333;">
