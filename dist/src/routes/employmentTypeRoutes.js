 ...
 */
router.get('/', EmploymentTypeController_1.EmploymentTypeController.getAll);
/**
 * @swagger
 ...
 */
router.get('/:id', EmploymentTypeController_1.EmploymentTypeController.getById);
/**
 * @swagger
 * components:
 *   schemas:
 ...
 */
router.post('/', EmploymentTypeController_1.EmploymentTypeController.create);
/**
 * @swagger
 * /api/employment-types/{id}:
 *   put:
 ...
 *         description: Employment type not found
 */
router.put('/:id', EmploymentTypeController_1.EmploymentTypeController.update);
/**
 * @swagger
 * /api/employment-types/{id}:
 *   delete:
 ...
 *         description: Employment type not found
 */
router.delete('/:id', EmploymentTypeController_1.EmploymentTypeController.delete);
